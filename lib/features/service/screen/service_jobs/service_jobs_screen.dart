...
class JobsScreen extends StatefulWidget {
  const JobsScreen({super.key, this.isProject = false});

  /// When `true`, this screen is being used under the "Projects" tab.
  /// Used to tweak UI labels accordingly.
...
class _JobsScreenState extends State<JobsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabs = [
      'All Jobs',
      widget.isProject ? 'My Project' : 'My Jobs',
      'Saved',
      'Active jobs',
    ];
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    widget.isProject ? 'Projects' : 'Jobs',
                    style: TextStyle(
                      fontSize: 24.sp,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(minHeight: 208.h),
        decoration: BoxDecoration(
